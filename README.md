...
Download a custom UniProt report with organism, protein names, go terms, comments, and kegg cross reference for fields. The full list of available fields and database cross-references can be found on the [UniProt site](http://www.uniprot.org/help/query-fields): 
```
